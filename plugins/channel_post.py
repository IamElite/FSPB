...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start', 'users','addshort','resetshort','seeshort', 'getpremiumusers' , 'broadcast', 'batch', 'genlink', 'upi', 'myplan', 'plans', 'stats', 'removepr', 'addpr', 'st']))
